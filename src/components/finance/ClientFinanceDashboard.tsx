    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Acompanhe seus gastos, pagamentos em garantia e histórico de transações
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl font-bold text-success">{stats.completedJobs}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl font-bold text-warning">{stats.pendingJobs}</div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-right">
                          <p className="font-semibold text-lg">
                            {showBalance ? formatCurrency(payment.amount) : '••••••'}
                          </p>
                        </div>
                        <div>
